...
// Verifies that PD3-based parallel synthsis with the DITT MAJ encoder works
// properly.
int main(void)
{
    chain c;

    {
        ...
        const auto result = parallel_pd_ditt_maj_synthesize(nr_in, non_iso_dags, c, std::thread::hardware_concurrency(), true);
